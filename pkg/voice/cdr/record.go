...
type CallRecord struct {
	...
	Transport     string `json:"transport"`                // sip / webrtc
	...
	AnsweredMs   int64     `json:"answered_ms,omitempty"` // setup time: INVITE→200 OK
	...
	HangupReason  string   `json:"hangup_reason,omitempty"` // BYE Reason header or internal cause
	HangupBy      string   `json:"hangup_by,omitempty"`     // local / remote
	SIPFinalCode  int      `json:"sip_final_code,omitempty"`
