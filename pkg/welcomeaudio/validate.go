...
// the per-DID welcome WAV referenced by TrunkNumber.WelcomeAudioURL.
//
// Two integration points consume this package:
//
//   - internal/handlers (trunk number create/update): call ValidateURL to
//     reject unreachable / non-audio / non-WAV URLs at write time.
//   - pkg/sip/conversation (AttachVoicePipeline): call FetchPCM at runtime
