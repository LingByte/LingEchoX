...
// substring-replacement table. Mirrors the legacy SIPHotwordCorrector
...
//     interface so the SIP-side wiring can pass any concrete
//     corrector (today: pkg/sip/conversation.SIPHotwordCorrector;
//     tomorrow: a per-tenant DB-driven rewriter, an LLM-based
//     corrector, etc.). Cascaded does NOT import the SIP-side
//     corrector type — keeps the engine free of SIP/HTTP deps.
//
