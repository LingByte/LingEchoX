...
// The SIP RTP transport, by contrast, expects exactly one 20 ms
...
// codec's 20 ms-advanced timestamp, and the SIP peer plays the audio
...
//     SIP phones (see voicedialog/tts_segmenter.go for the legacy
...
// ms prebuffer" — the modal SIP bridge configuration.
...
// NewPacerStage is the exported entry point so SIP-side wiring (or
