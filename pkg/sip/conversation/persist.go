...
// cmd/sip wires this to pkg/sip/persist.CallStore.SaveConversationTurn.
//
...
//   - BYE → TakeRecording → SIPCallPersistStore.OnBye → stereo WAV preferred (L=user R=AI per-leg decode, no mono ducking),
