...
//
// Cross-cutting SIP helpers live in pkg/sip/stack and pkg/sip/session as needed.
//
// Boundaries:
//   - Uses the same UDP socket as SIPServer via SignalingSender (SendSIP).
//   - Handles responses via Manager.HandleSIPResponse wired to stack.EndpointConfig.OnSIPResponse.
