...
// endVoiceDialogBridge — see invite_meta.go for the LingEchoX-side
// implementation; it calls both voicedialog.EndCall (legacy direct path)
// and fireOnTerminate (interface path) so both routes are honoured.
