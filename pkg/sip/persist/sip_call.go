...
// ApplyRTPMediaToSIPCall fills RTP/codec columns after SDP negotiation.
...
// SIPCallFromInboundInvite fills a SIPCall from an inbound INVITE.
...
// ApplyInboundInviteFailure marks the call failed after a final error response.
