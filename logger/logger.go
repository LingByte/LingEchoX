...
func (l *Logger) Spawn() *Logger {
	...
	return &Logger{_log.WithField("x-reqid", l.reqID), l.reqID}
}

// NewWithSlack new log with slack hook
// @params slackhook slack hook url
func NewWithSlack(slackhook string, o ...interface{}) *Logger {
	_log := New(o...)
	_log.AddHook(&slackrus.SlackrusHook{
		HookURL:        slackhook,
...
// RPC logger interface implement
