/** Converts Tailwind-style HSL token "262 83% 42%" to #rrggbb for Arco ConfigProvider. */
export function hslTokenToHex(hslToken: string, fallback = '#5B21B6'): string {
...
export function readPrimaryColorFromDocument(fallback = '#5B21B6'): string {
